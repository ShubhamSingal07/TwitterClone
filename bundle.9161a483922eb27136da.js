...
/***/ "./app/actions/addTweet.js":
/*!*********************************!*\
  !*** ./app/actions/addTweet.js ***!
  \*********************************/
/*! exports provided: addTweet */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addTweet", function() { return addTweet; });
...
var addTweetSuccess = function addTweetSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].addTweetSuccess,
    payload: payload
  };
};

var addTweetInProgress = function addTweetInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].addTweetInProgress
  };
};

var addTweetFail = function addTweetFail(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].addTweetFail,
    payload: payload
  };
};
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return dispatch(addTweetInProgress());
              ...
              case 2:
                ...
                return _context.abrupt("return", dispatch(addTweetFail({
              ...
              case 10:
                data = _context.sent;
                if (data.success) dispatch(addTweetSuccess(data.tweet));else if (data.userNotPresent) dispatch(Object(___WEBPACK_IMPORTED_MODULE_1__["logout"])());
                _context.next = 17;
                break;
...
var dislikeSuccess = function dislikeSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].dislikeSuccess,
    payload: payload
  };
};

var dislikeInProgress = function dislikeInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].dislikeInProgress
  };
};

var dislikeFail = function dislikeFail() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].dislikeFail
  };
};
...
var dislike = function dislike(_ref) {
  ...
  return (
    ...
    function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(dispatch) {
        var tweetByUserId, tweetid, res, data;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                tweetByUserId = tweetItem.tweetByUserId, tweetid = tweetItem.tweetid;
                _context.next = 3;
                return dispatch(dislikeInProgress());
              ...
              case 3:
                ...
                return fetch("".concat(___WEBPACK_IMPORTED_MODULE_1__["url"], "/api/dislike"), {
                  ...
                  body: "tweetByUserId=".concat(tweetByUserId, "&tweetid=").concat(tweetid)
                });
              ...
              case 9:
                data = _context.sent;
                if (data.success) dispatch(dislikeSuccess({
                  tweetid: tweetid,
                  userid: userid
                }));else if (data.userNotPresent) dispatch(Object(___WEBPACK_IMPORTED_MODULE_1__["logout"])());
                _context.next = 16;
                break;
...
/***/ "./app/actions/fetchHomePage.js":
/*!**************************************!*\
  !*** ./app/actions/fetchHomePage.js ***!
  \**************************************/
/*! exports provided: fetchHomePage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var homepageSuccess = function homepageSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].homepageSuccess,
    payload: payload
  };
};

var homepageFail = function homepageFail() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].homepageFail
  };
};

var homepageInProgress = function homepageInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].homepageInProgress
  };
};

var loginFail = function loginFail(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].loginFail,
    payload: payload
  };
};

var fetchHomePage = function fetchHomePage() {
  return (
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return dispatch(homepageInProgress());
...
var followInProgress = function followInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].followInProgress
  };
};

var followFail = function followFail(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].followFail,
    payload: payload
  };
};

var followSuccess = function followSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].followSuccess,
    payload: payload
  };
};
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return dispatch(followInProgress());
              ...
              case 8:
                data = _context.sent;
                if (data.success) dispatch(followSuccess({
                  tweets: data.tweets,
                  userid: id
                }));else if (data.userNotPresent) dispatch(Object(___WEBPACK_IMPORTED_MODULE_1__["logout"])());
                _context.next = 15;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _login__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login */ "./app/actions/login.js");
...
/* harmony import */ var _signup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./signup */ "./app/actions/signup.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "signup", function() { return _signup__WEBPACK_IMPORTED_MODULE_1__["signup"]; });

/* harmony import */ var _fetchHomePage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fetchHomePage */ "./app/actions/fetchHomePage.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "fetchHomePage", function() { return _fetchHomePage__WEBPACK_IMPORTED_MODULE_2__["fetchHomePage"]; });

/* harmony import */ var _logout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./logout */ "./app/actions/logout.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "logout", function() { return _logout__WEBPACK_IMPORTED_MODULE_3__["logout"]; });

/* harmony import */ var _follow__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./follow */ "./app/actions/follow.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "follow", function() { return _follow__WEBPACK_IMPORTED_MODULE_4__["follow"]; });

/* harmony import */ var _unfollow__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./unfollow */ "./app/actions/unfollow.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "unfollow", function() { return _unfollow__WEBPACK_IMPORTED_MODULE_5__["unfollow"]; });

/* harmony import */ var _like__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./like */ "./app/actions/like.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "like", function() { return _like__WEBPACK_IMPORTED_MODULE_6__["like"]; });

/* harmony import */ var _dislike__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dislike */ "./app/actions/dislike.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "dislike", function() { return _dislike__WEBPACK_IMPORTED_MODULE_7__["dislike"]; });

/* harmony import */ var _addTweet__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./addTweet */ "./app/actions/addTweet.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "addTweet", function() { return _addTweet__WEBPACK_IMPORTED_MODULE_8__["addTweet"]; });
...
var likeSuccess = function likeSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].likeSuccess,
    payload: payload
  };
};

var likeInProgress = function likeInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].likeInProgress
  };
};

var likeFail = function likeFail() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].likeFail
  };
};
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                tweetByUserId = tweetItem.tweetByUserId, tweetid = tweetItem.tweetid;
                _context.next = 3;
                return dispatch(likeInProgress());
              ...
              case 9:
                data = _context.sent;
                if (data.success) dispatch(likeSuccess({
                  tweetid: tweetid,
                  userid: userid
                }));else if (data.userNotPresent) dispatch(Object(___WEBPACK_IMPORTED_MODULE_1__["logout"])());
                _context.next = 16;
...
var loginInProgress = function loginInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].loginInProgress
  };
};

var loginSuccess = function loginSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].loginSuccess,
    payload: payload
  };
};
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return dispatch(loginInProgress());
              ...
              case 2:
                ...
                return _context.abrupt("return", dispatch(loginFail({
              ...
              case 4:
                ...
                return fetch("".concat(___WEBPACK_IMPORTED_MODULE_1__["url"], "/api/login"), {
                  ...
                  body: "username=".concat(username, "&password=").concat(password)
                });
...
var logout = function logout() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].logout
  };
};

/***/ }),

/***/ "./app/actions/refresh.js":
/*!********************************!*\
  !*** ./app/actions/refresh.js ***!
  \********************************/
...
var refreshSuccess = function refreshSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].refreshSuccess,
    payload: payload
  };
};

var refreshInProgress = function refreshInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].refreshInProgress
  };
};

var refreshFail = function refreshFail(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].refreshFail,
    payload: payload
  };
};
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return dispatch(refreshInProgress());
...
var SignupInProgress = function SignupInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].SignupInProgress
  };
};

var SignupSuccess = function SignupSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].SignupSuccess,
    payload: payload
  };
};

var SignupFail = function SignupFail(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].SignupFail,
    payload: payload
  };
};
...
var signup = function signup(_ref) {
  var username = _ref.username,
      password = _ref.password,
      passwordAgain = _ref.passwordAgain;
  return (
    /*#__PURE__*/
    function () {
      var _ref2 = _asyncToGenerator(
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return dispatch(SignupInProgress());
              ...
              case 2:
                ...
                return _context.abrupt("return", dispatch(SignupFail({
                  errors: 'Fields cannot be empty'
                })));
...
var unfollowInProgress = function unfollowInProgress() {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowInProgress
  };
};

var unfollowFail = function unfollowFail(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowFail,
    payload: payload
  };
};

var unfollowSuccess = function unfollowSuccess(payload) {
  return {
    type: _store_actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowSuccess,
    payload: payload
  };
};

var unfollow = function unfollow(id) {
  return (
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return dispatch(unfollowInProgress());
              ...
              case 8:
                data = _context.sent;
                if (data.success) dispatch(unfollowSuccess({
                  userid: id
                }));else if (data.userNotPresent) dispatch(Object(___WEBPACK_IMPORTED_MODULE_1__["logout"])());
                _context.next = 15;
                break;
...
var Footer = function Footer() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "font-weight-bold text-center m-1 p-2"
  }, "Made with \u2764 by", ' ', react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    href: "https://github.com/ShubhamSingal07",
    target: "_blank"
  }, ' ', "Shubham Singal")));
};
...
/***/ "./app/components/Loader/BirdLoader/index.jsx":
/*!****************************************************!*\
  !*** ./app/components/Loader/BirdLoader/index.jsx ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./app/components/Loader/BirdLoader/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../public/images/TwitterLogo.png */ "./public/images/TwitterLogo.png");
/* harmony import */ var _public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_2__);




var BirdLoader = function BirdLoader() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "container w-25"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
    className: "w-50",
    src: _public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_2___default.a,
    id: "loader_img"
  }));
};

/* harmony default export */ __webpack_exports__["default"] = (BirdLoader);

/***/ }),

/***/ "./app/components/Loader/BirdLoader/style.scss":
/*!*****************************************************!*\
  !*** ./app/components/Loader/BirdLoader/style.scss ***!
  \*****************************************************/
...
/***/ "./app/components/Loader/DotsLoader/index.jsx":
/*!****************************************************!*\
  !*** ./app/components/Loader/DotsLoader/index.jsx ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./app/components/Loader/DotsLoader/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony default export */ __webpack_exports__["default"] = (DotsLoader);

/***/ }),

/***/ "./app/components/Loader/DotsLoader/style.scss":
/*!*****************************************************!*\
  !*** ./app/components/Loader/DotsLoader/style.scss ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./app/components/LoginSignup/index.jsx":
/*!**********************************************!*\
  !*** ./app/components/LoginSignup/index.jsx ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../actions */ "./app/actions/index.js");
...
function (_React$PureComponent) {
  _inherits(LoginSignup, _React$PureComponent);
  ...
  function LoginSignup() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LoginSignup)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "handleValueChange", function (e) {
  ...
  _createClass(LoginSignup, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          isLoginPage = _this$props.isLoginPage,
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "input-group input-group-sm mb-3"
      }, isLoginPage ? null : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        className: "form-control",
        type: "password",
        name: "passwordAgain",
        value: passwordAgain,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    login: function login(payload) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["login"](payload));
    },
    signup: function signup(payload) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["signup"](payload));
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(LoginSignup));
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./app/components/NavBar/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../actions */ "./app/actions/index.js");
/* harmony import */ var _public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../public/images/TwitterLogo.png */ "./public/images/TwitterLogo.png");
/* harmony import */ var _public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _public_images_HomeLogo_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../public/images/HomeLogo.png */ "./public/images/HomeLogo.png");
/* harmony import */ var _public_images_HomeLogo_png__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_public_images_HomeLogo_png__WEBPACK_IMPORTED_MODULE_6__);
...
var NavBar = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(function (_ref) {
  var logout = _ref.logout;
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "navBar sticky-top d-flex justify-content-around align-items-center"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Link"], {
    to: "/"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
    src: _public_images_HomeLogo_png__WEBPACK_IMPORTED_MODULE_6___default.a,
    width: "40px",
    height: "40px"
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Home")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
    id: "tweet_img",
    src: _public_images_TwitterLogo_png__WEBPACK_IMPORTED_MODULE_5___default.a,
    width: "24px",
    height: "21px"
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    logout: function logout() {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_4__["logout"]());
    }
  };
};
...
/***/ "./app/components/ProfileBar/index.jsx":
/*!*********************************************!*\
  !*** ./app/components/ProfileBar/index.jsx ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./app/components/ProfileBar/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_2__);



var ProfileBar = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(function (_ref) {
  var username = _ref.username;
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "profileBar m-1 mt-2 p-3"
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, username), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, "@", username)));
});
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(ProfileBar));

/***/ }),

/***/ "./app/components/ProfileBar/style.scss":
/*!**********************************************!*\
  !*** ./app/components/ProfileBar/style.scss ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./app/components/TweetList/TweetItem/index.jsx":
/*!******************************************************!*\
  !*** ./app/components/TweetList/TweetItem/index.jsx ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions */ "./app/actions/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./app/components/TweetList/TweetItem/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_3__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(TweetItem, _React$PureComponent);
  ...
  function TweetItem() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TweetItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(TweetItem, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          tweetItem = _this$props.tweetItem,
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "p-3"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, tweetItem.tweetByUserName), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, tweetItem.tweet)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        className: "btn",
        onClick: handleLike
      }, isLiked ? '❤️' : '🖤'), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, tweetItem.likes))));
    }
  }], [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, state) {
      var user = props.user,
          tweetItem = props.tweetItem;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    like: function like(payload) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["like"](payload));
    },
    dislike: function dislike(payload) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["dislike"](payload));
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(TweetItem));

/***/ }),

/***/ "./app/components/TweetList/TweetItem/style.scss":
/*!*******************************************************!*\
  !*** ./app/components/TweetList/TweetItem/style.scss ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./app/components/TweetList/index.jsx":
/*!********************************************!*\
  !*** ./app/components/TweetList/index.jsx ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _TweetItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./TweetItem */ "./app/components/TweetList/TweetItem/index.jsx");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../actions */ "./app/actions/index.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../components */ "./app/components/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.scss */ "./app/components/TweetList/style.scss");
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(TweetList, _React$PureComponent);
  ...
  function TweetList() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(TweetList)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(TweetList, [{
    ...
    value: function render() {
      ...
      var newTweet = this.state.newTweet;
      var _this$props = this.props,
          addTweet = _this$props.addTweet,
          tweets = _this$props.tweets,
          inProgress = _this$props.inProgress,
          errors = _this$props.errors;

      var handleAddTweet = function handleAddTweet() {
        addTweet(newTweet);
      ...
      }, "Tweet")))), inProgress ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_4__["DotsLoader"], null) : null, errors && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "alert alert-danger"
      }, errors), tweets.length == 0 ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "m-3"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
        className: "font-weight-bold"
      }, "What? No Tweets yet?"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "This empty timeline won\u2019t be around for long. Start following people and you\u2019ll see Tweets show up here.")) : tweets.map(function (tweet) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_TweetItem__WEBPACK_IMPORTED_MODULE_2__["default"], {
          tweetItem: tweet,
          key: tweet.tweetid
        });
      }));
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addTweet: function addTweet(tweet) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_3__["addTweet"](tweet));
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(TweetList));

/***/ }),

/***/ "./app/components/TweetList/style.scss":
/*!*********************************************!*\
  !*** ./app/components/TweetList/style.scss ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./app/components/UsersBar/UsersItem/index.jsx":
/*!*****************************************************!*\
  !*** ./app/components/UsersBar/UsersItem/index.jsx ***!
  \*****************************************************/
/*! exports provided: default */
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../actions */ "./app/actions/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./app/components/UsersBar/UsersItem/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_3__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(UsersItem, _React$PureComponent);
  ...
  function UsersItem() {
    ...
    _classCallCheck(this, UsersItem);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(UsersItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(UsersItem, [{
    ...
    value: function render() {
      ...
      var handleFollowing = function handleFollowing() {
        if (isFollowing) {
          unfollow(id);
        } else {
          follow(id);
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "usersItem p-1"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, username), isFollowing ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    follow: function follow(id) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["follow"](id));
    },
    unfollow: function unfollow(id) {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["unfollow"](id));
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(UsersItem));

/***/ }),

/***/ "./app/components/UsersBar/UsersItem/style.scss":
/*!******************************************************!*\
  !*** ./app/components/UsersBar/UsersItem/style.scss ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./app/components/UsersBar/index.jsx":
/*!*******************************************!*\
  !*** ./app/components/UsersBar/index.jsx ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _UsersItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./UsersItem */ "./app/components/UsersBar/UsersItem/index.jsx");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components */ "./app/components/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./app/components/UsersBar/style.scss");
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(UsersBar, _React$PureComponent);

  function UsersBar() {
    _classCallCheck(this, UsersBar);

    return _possibleConstructorReturn(this, _getPrototypeOf(UsersBar).apply(this, arguments));
  }

  _createClass(UsersBar, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          ...
          inProgress = _this$props.inProgress;
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "usersBar m-1 mt-2 d-flex justify-content-center"
      ...
      }, "Who to follow?"), inProgress ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["DotsLoader"], null) : null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-2"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "m-auto"
      }, users.length == 1 ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "m-3"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
        className: "font-weight-bold"
      }, "No Users to follow?"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Invite your friends to join Twitter.")) : users.map(function (_ref) {
        var username = _ref.username,
            id = _ref.id;

        if (userid != id) {
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_UsersItem__WEBPACK_IMPORTED_MODULE_2__["default"], {
            username: username,
            key: id,
            id: id
          });
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(UsersBar));

/***/ }),

/***/ "./app/components/UsersBar/style.scss":
/*!********************************************!*\
  !*** ./app/components/UsersBar/style.scss ***!
  \********************************************/
/*! no static exports found */
...
/*!*********************************!*\
  !*** ./app/components/index.js ***!
  \*********************************/
/*! exports provided: BirdLoader, DotsLoader, LoginSignup, NavBar, ProfileBar, TweetList, UsersBar, Footer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Loader_BirdLoader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Loader/BirdLoader */ "./app/components/Loader/BirdLoader/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BirdLoader", function() { return _Loader_BirdLoader__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _Loader_DotsLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Loader/DotsLoader */ "./app/components/Loader/DotsLoader/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DotsLoader", function() { return _Loader_DotsLoader__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _LoginSignup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./LoginSignup */ "./app/components/LoginSignup/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LoginSignup", function() { return _LoginSignup__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _NavBar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./NavBar */ "./app/components/NavBar/index.jsx");
...
/* harmony import */ var _ProfileBar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ProfileBar */ "./app/components/ProfileBar/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ProfileBar", function() { return _ProfileBar__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _TweetList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./TweetList */ "./app/components/TweetList/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TweetList", function() { return _TweetList__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony import */ var _UsersBar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./UsersBar */ "./app/components/UsersBar/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "UsersBar", function() { return _UsersBar__WEBPACK_IMPORTED_MODULE_6__["default"]; });

/* harmony import */ var _Footer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Footer */ "./app/components/Footer/index.jsx");
...
/***/ "./app/containers/HomePage/index.jsx":
/*!*******************************************!*\
  !*** ./app/containers/HomePage/index.jsx ***!
  \*******************************************/
/*! exports provided: default */
...
function (_React$PureComponent) {
  ...
  _createClass(HomePage, [{
      ...
      regeneratorRuntime.mark(function _callee() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                fetchHomePage = this.props.fetchHomePage;
                _context.next = 3;
    ...
    value: function render() {
      ...
      if (loader) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["BirdLoader"], null);
      }

      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["NavBar"], null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "container align-items-baseline"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "d-flex justify-content-around"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["ProfileBar"], null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["TweetList"], null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["UsersBar"], null))));
    }
  }]);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchHomePage: function fetchHomePage() {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_2__["fetchHomePage"]());
    }
  };
};
...
/***/ "./app/containers/LoginPage/index.jsx":
/*!********************************************!*\
  !*** ./app/containers/LoginPage/index.jsx ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components */ "./app/components/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./app/containers/LoginPage/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_4__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(LoginPage, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "mb-3 mt-3 font-weight-bold"
      }, "Log in to Twitter"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["LoginSignup"], {
        isLoginPage: true
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-3",
        id: "link"
      }, "New to Twitter?", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Link"], {
        to: "/signup"
      }, " Sign up now")));
    }
  }]);
...
/***/ "./app/containers/LoginPage/style.scss":
/*!*********************************************!*\
  !*** ./app/containers/LoginPage/style.scss ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./app/containers/SignupPage/index.jsx":
/*!*********************************************!*\
  !*** ./app/containers/SignupPage/index.jsx ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components */ "./app/components/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style.scss */ "./app/containers/SignupPage/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_4__);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
  ...
  _createClass(SignupPage, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "mt-3 mb-3 font-weight-bold"
      }, "Create your Account"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_3__["LoginSignup"], {
        isLoginPage: false
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "p-3",
        id: "link"
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps)(SignupPage));

/***/ }),

/***/ "./app/containers/SignupPage/style.scss":
/*!**********************************************!*\
  !*** ./app/containers/SignupPage/style.scss ***!
  \**********************************************/
/*! no static exports found */
...
/*!*********************************!*\
  !*** ./app/containers/index.js ***!
  \*********************************/
/*! exports provided: HomePage, LoginPage, SignupPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _HomePage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./HomePage */ "./app/containers/HomePage/index.jsx");
...
/* harmony import */ var _LoginPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LoginPage */ "./app/containers/LoginPage/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LoginPage", function() { return _LoginPage__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _SignupPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SignupPage */ "./app/containers/SignupPage/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SignupPage", function() { return _SignupPage__WEBPACK_IMPORTED_MODULE_2__["default"]; });
...
/***/ "./app/controllers/EntryController/index.jsx":
/*!***************************************************!*\
  !*** ./app/controllers/EntryController/index.jsx ***!
  \***************************************************/
/*! exports provided: default */
...
var EntryController = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(function (_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", history.push('/login'));

            case 7:
              return _context.abrupt("return", children || null);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    refresh: function refresh() {
      return dispatch(_actions__WEBPACK_IMPORTED_MODULE_3__["refresh"]());
    }
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["withRouter"])(Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps, mapDispatchToProps)(EntryController)));
...
/*!**********************************!*\
  !*** ./app/controllers/index.js ***!
  \**********************************/
/*! exports provided: EntryController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _EntryController__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EntryController */ "./app/controllers/EntryController/index.jsx");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "EntryController", function() { return _EntryController__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony import */ var _containers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./containers */ "./app/containers/index.js");
/* harmony import */ var _controllers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controllers */ "./app/controllers/index.js");
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components */ "./app/components/index.js");
/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./styles/main.scss */ "./app/styles/main.scss");
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_3__["Provider"], {
        ...
        path: "/login",
        exact: true,
        component: _containers__WEBPACK_IMPORTED_MODULE_5__["LoginPage"]
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Route"], {
        path: "/signup",
        exact: true,
        component: _containers__WEBPACK_IMPORTED_MODULE_5__["SignupPage"]
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Route"], {
        render: function render() {
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_controllers__WEBPACK_IMPORTED_MODULE_6__["EntryController"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["Route"], {
            path: "/",
            exact: true,
            component: _containers__WEBPACK_IMPORTED_MODULE_5__["HomePage"]
          }));
        }
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components__WEBPACK_IMPORTED_MODULE_7__["Footer"], null));
    }
  }]);
...
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./reducers */ "./app/store/reducers/index.js");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./actions */ "./app/store/actions/index.js");
...
var store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_2__["default"], Object(redux__WEBPACK_IMPORTED_MODULE_0__["compose"])(Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_1__["default"]), Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(localStorageMiddleware)));
/* harmony default export */ __webpack_exports__["default"] = (store);

/***/ }),

/***/ "./app/store/reducers/authReducer.js":
/*!*******************************************!*\
  !*** ./app/store/reducers/authReducer.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions */ "./app/store/actions/index.js");
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
var authReducer = function authReducer() {
  ...
  switch (type) {
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].loginInProgress:
      return _objectSpread({}, state, {
        inProgress: true,
        errors: undefined
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].loginSuccess:
      return _objectSpread({}, state, {
        inProgress: false,
        loggedIn: true,
        errors: undefined
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].loginFail:
      return _objectSpread({}, state, {
        inProgress: false,
        loggedIn: false,
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].SignupSuccess:
      return _objectSpread({}, state, {
        inProgress: false,
        errors: undefined,
        loggedIn: true
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].SignupInProgress:
      return _objectSpread({}, state, {
        inProgress: true,
        errors: undefined
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].SignupFail:
      return _objectSpread({}, state, {
        inProgress: false,
        errors: payload.errors
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].logout:
      return _objectSpread({}, state, {
        inProgress: false,
        loggedIn: false,
        errors: undefined
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].refreshInProgress:
      return _objectSpread({}, state, {
        inProgress: false,
        errors: undefined
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].refreshSuccess:
      return _objectSpread({}, state, {
        inProgress: false,
        loggedIn: true,
        errors: undefined
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].refreshFail:
      return _objectSpread({}, state, {
        inProgress: false,
        loggedIn: false,
        errors: payload.errors
...
/***/ "./app/store/reducers/followingReducer.js":
/*!************************************************!*\
  !*** ./app/store/reducers/followingReducer.js ***!
  \************************************************/
/*! exports provided: default */
...
var followingReducer = function followingReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    inProgress: false,
    data: []
  };
  ...
  switch (type) {
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].homepageSuccess:
      return _objectSpread({}, state, {
        inProgress: false,
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].followSuccess:
      return _objectSpread({}, state, {
        inProgress: false,
        data: [].concat(_toConsumableArray(state.data), [payload.userid])
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].followInProgress:
      return _objectSpread({}, state, {
        inProgress: true
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].followFail:
      return _objectSpread({}, state, {
        inProgress: false
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowSuccess:
      return _objectSpread({}, state, {
        inProgress: false,
        data: state.data.filter(function (value) {
          return value != payload.userid;
        })
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowInProgress:
      return _objectSpread({}, state, {
        inProgress: true
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowFail:
      return _objectSpread({}, state, {
        inProgress: false
      });
...
/* harmony default export */ __webpack_exports__["default"] = (followingReducer);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
/* harmony import */ var _authReducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./authReducer */ "./app/store/reducers/authReducer.js");
/* harmony import */ var _userReducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./userReducer */ "./app/store/reducers/userReducer.js");
/* harmony import */ var _usersReducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./usersReducer */ "./app/store/reducers/usersReducer.js");
/* harmony import */ var _tweetsReducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tweetsReducer */ "./app/store/reducers/tweetsReducer.js");
/* harmony import */ var _followingReducer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./followingReducer */ "./app/store/reducers/followingReducer.js");
...
var Reducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
  ...
  tweets: _tweetsReducer__WEBPACK_IMPORTED_MODULE_4__["default"],
  following: _followingReducer__WEBPACK_IMPORTED_MODULE_5__["default"]
});
/* harmony default export */ __webpack_exports__["default"] = (Reducer);

/***/ }),

/***/ "./app/store/reducers/tweetsReducer.js":
/*!*********************************************!*\
  !*** ./app/store/reducers/tweetsReducer.js ***!
  \*********************************************/
/*! exports provided: default */
...
var tweetsReducer = function tweetsReducer() {
  ...
  switch (type) {
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].homepageFail:
      return _objectSpread({}, state, {
        loader: false,
        errors: payload.errors
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].homepageInProgress:
      return _objectSpread({}, state, {
        loader: true,
        errors: undefined
      });
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].followSuccess:
      return _objectSpread({}, state, {
        errors: undefined,
        data: [].concat(_toConsumableArray(payload.tweets), _toConsumableArray(state.data))
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].unfollowSuccess:
      return _objectSpread({}, state, {
        data: state.data.filter(function (tweet) {
          return tweet.tweetByUserId != payload.userid;
        }),
        errors: undefined
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].likeSuccess:
      {
        var newData = state.data;
        newData = newData.map(function (tweet) {
          if (tweet.tweetid == payload.tweetid) {
            return _objectSpread({}, tweet, {
              likes: tweet.likes + 1,
              likedby: [payload.userid].concat(_toConsumableArray(tweet.likedby))
            });
          } else {
            return tweet;
          }
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].dislikeSuccess:
      {
        var _newData = state.data;
        _newData = _newData.map(function (tweet) {
          if (tweet.tweetid == payload.tweetid) {
            var newLikedby = tweet.likedby.filter(function (val) {
              return val != payload.userid;
            });
            return _objectSpread({}, tweet, {
              likes: tweet.likes - 1,
              likedby: newLikedby
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].addTweetFail:
      return _objectSpread({}, state, {
        inProgress: false,
        errors: payload.errors
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].addTweetSuccess:
      return _objectSpread({}, state, {
        data: [payload].concat(_toConsumableArray(state.data)),
        errors: undefined,
        inProgress: false
      });

    case _actions__WEBPACK_IMPORTED_MODULE_0__["default"].addTweetInProgress:
      return _objectSpread({}, state, {
        errors: undefined,
        inProgress: true
      });
...
/***/ "./app/store/reducers/userReducer.js":
/*!*******************************************!*\
  !*** ./app/store/reducers/userReducer.js ***!
  \*******************************************/
/*! exports provided: default */
...
/***/ "./app/store/reducers/usersReducer.js":
/*!********************************************!*\
  !*** ./app/store/reducers/usersReducer.js ***!
  \********************************************/
/*! exports provided: default */
...
module.exports = "data:image/png;base64,"

/***/ }),

/***/ "./public/images/TwitterLogo.png":
/*!***************************************!*\
  !*** ./public/images/TwitterLogo.png ***!
  \***************************************/
/*! no static exports found */
...
module.exports = "data:image/png;base64,"

/***/ }),

/***/ 0:
/*!********************************************!*\
  !*** multi babel-polyfill ./app/index.jsx ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! G:\Webd\Projects\TwitterClone\Frontend\app/index.jsx */"./app/index.jsx");


/***/ })

/******/ });
//# sourceMappingURL=bundle.9161a483922eb27136da.js.map